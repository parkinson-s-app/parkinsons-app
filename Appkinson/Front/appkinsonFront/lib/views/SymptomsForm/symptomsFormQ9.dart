          ...
          Expanded(
            ...
            child: Column(
              children: <Widget>[
                ...
                RadioListTile<SigningCharacter>(
                  title: const Text('Enlentecimiento discreto y/o reducción de la amplitud (11-15/5segundos)'),
                ...
                RadioListTile<SigningCharacter>(
                  title: const Text('Moderadamente alterado. Fatigoso de manera evidente y precoz. Puede haber detenciones ocasionales en el movimiento (7-10/5segundos)'),
                ...
                RadioListTile<SigningCharacter>(
                  title: const Text('Muy alterado. Frecuentes titubeos al iniciar los movimientos o detenciones mientras se realiza el movimiento (3-6/5segundos).'),
